        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {!props.sidebarOpen && (
            <button
              ...
              className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm transition hover:border-primary hover:text-primary dark:border-strokedark dark:bg-boxdark"
              title="Buka sidebar"
            >
